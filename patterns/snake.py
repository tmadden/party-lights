...
async def snake(lights):
    ...
    while not True:
        ...
        if len(snake) > 0:
            lights[index(snake[-1])].set_state(on)
        if len(snake) > 1:
            lights[index(snake[-2])].set_state(rgb(255, 255, 255))
        if len(snake) > 2:
            lights[index(snake[-3])].set_state(rgb(255, 100, 255))
        if len(snake) > 3:
            lights[index(snake[-4])].set_state(rgb(255, 100, 255))
